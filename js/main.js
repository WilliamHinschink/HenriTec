...
$(document).ready(function () {
    ...
    $('#owl-clients').owlCarousel({
        ...
        responsive: {
            0: {
                items: 3 // One item from 0px up to 479px
            },
            480: {
                items: 4 // Two items from 480px up to 677px
            },
            678: {
                items: 5 // Three items from 677px up to 959px
            },
            960: {
                items: 7 // Five items from 960px up
            }
        }
    });
});
...
(function ($){
    var $window = $(window),
        ...
        $window.resize(function resize(){
            if($window.width() < 757){
                return $contactsSocial.addClass('navbar-fixed-bottom');
            }
            $contactsSocial.removeClass('navbar-fixed-bottom');
        }).trigger('resize');
})(jQuery);
